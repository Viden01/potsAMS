...
<body>
    <div class="container mb-2">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <!-- Form -->
                <form class="text-center border border-light p-5" id="punch" action="attendance_process.php" method="POST">
                    ...
                    <input type="time" id="time_in" name="time_in" class="form-control mb-4" placeholder="Time In" required="">
                    <input type="time" id="time_out" name="time_out" class="form-control mb-4" placeholder="Time Out">
                    <input type="date" id="date_attendance" name="date_attendance" class="form-control mb-4" placeholder="Date" required="">
