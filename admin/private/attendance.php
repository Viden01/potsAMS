    ...
    if ($query === FALSE) {
        ...
        while ($row = $query->fetch_assoc()) {
            ...
            if (!empty($row['latitude']) && !empty($row['longitude'])) {
                ...
                $location_display = '<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d62627.84334478038!2d' . $longitude . '!3d' . $latitude . '!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sph!4v1734977097856!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>';
            } else {
            ...
            <tr>
                ...
                <td>".$photo_display."</td>
                     <td>".htmlentities($row['lattitude'])."</td>
                <td>
