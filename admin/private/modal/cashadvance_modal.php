    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div id="msg"></div>
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                      <div >
                       <input id="employee_id" alt="employee_id" class="form-control" type="text" required="" />
                      </div>
                  	</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div>
                        <input id="amount" alt="amount"  class="form-control" type="text" required="" />
                      </div>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
            	...
            	<button type="button" class="btn btn-primary btn-flat" name="add" id="addscash"><i class="fa fa-save"></i> Save</button>
            	</form>
          	</div>
        </div>
    </div>
              ...
              e.preventDefault();///i hahandle nito yung submit button kung wala laman na, nilagay sa field
                ...
                const amount = $('input[alt=amount]').val();
                 ...
                 $.ajax({
                     ...
                     url: 'processing/cashadvance_process.php',
                     async: false,
                     cache: false,
