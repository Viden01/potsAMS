        ...
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 ...
                 <h4 class="modal-title"><b><span class="date">Delete Position</span> </span></b></h4>
          	</div>
          	<div class="modal-body">
             <div id="msg"></div>
            	<form class="form-horizontal" method="POST">
                <input type="hidden" id="del_id" name="id">
                 <h4 class=""><b><span class="date">Do you want to delete Position ? </span>" <span id="del_perhr"></span> "</b></h4>
            	</div>
              ...
              e.preventDefault();///i hahandle nito yung submit button kung wala laman na, nilagay sa field
                ...
                const id = $('input[id=del_id]').val();
                 $.ajax({
                     ...
                     url: 'processing/Delete_position_process.php',
                     async: false,
                     cache: false,
